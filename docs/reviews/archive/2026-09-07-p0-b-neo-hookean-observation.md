...
> 過去記録：本文は、記録対象時点における証拠を保持する。旧体制および次タスクに関する記載は、現行の作業指示ではない。現行体制は[記録の扱い](../README.md)および[開発契約](../../../AGENTS.md)に従う。
...
The authority documents remain the [design specification](../../specs/2026-09-14-febio-llm-cae-harness-design-v2.md) and [greenfield plan](../../plans/2026-09-14-febio-cae-harness-greenfield-plan.md). This report is an investigation record and does not amend either document.
...
1. [FEBio LLM CAE Harness design v2](../../specs/2026-09-14-febio-llm-cae-harness-design-v2.md) — repository authority.
2. [FEBio CAE Harness greenfield plan](../../plans/2026-09-14-febio-cae-harness-greenfield-plan.md) — repository authority.
