...
権威文書は[設計仕様書](../../specs/2026-09-14-febio-llm-cae-harness-design-v2.md)と[実装・検証計画](../../plans/2026-09-14-febio-cae-harness-greenfield-plan.md)である。この報告は権威文書を置き換えない。
...
2. [FEBio CAE Harness greenfield plan](../../plans/2026-09-14-febio-cae-harness-greenfield-plan.md) — repository authority; §5.1 synthetic elastic patch.
