...
The design authority is `docs/specs/2026-09-14-febio-llm-cae-harness-design-v2.md`, with the P1 planning authority in `docs/plans/2026-09-14-febio-cae-harness-greenfield-plan.md`. This slice follows the physical/calculation-spec boundary in design section 5.2, the result-quality obligations in section 8.3, and the CT-01 and QA-01 gates in the plan.
